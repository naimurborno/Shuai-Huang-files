...
config['Feature_data_path'] = "/media/borno/Downloads/Downloads/SHUAI HUANG PROJECT/Features" # Path For the Feature
config['Cluster_mat_data_path']="/media/borno/Downloads/Downloads/SHUAI HUANG PROJECT/Cluster_index_mat"
